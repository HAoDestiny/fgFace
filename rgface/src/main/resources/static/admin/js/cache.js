...
layui.use(['form','jquery',"layer"],function() {
    ...
    if(window.sessionStorage.getItem('userFace') &&  $(".userAvatar").length > 0){
        ...
        $("#userFace").attr("src","static/admin/images/face.jpg");
    }

    //公告层Illegal continue statement: no surrounding iteration statement
    function showNotice(){
        layer.open({
            type: 1,
            title: "系统公告",
            ...
            btn: ['火速围观'],
            moveType: 1,
            content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p class="layui-red">人脸识别后台管理系统全新版本</p></pclass></p><p>v1.0发布时间待定<span class="layui-red">这里可以写一些系统公告之类的信息发布</span></p></div>',
    ...
    function lockPage(){
        layer.open({
            ...
            content : '<div class="admin-header-lock" id="lock-box">'+
                            '<div class="admin-header-lock-img"><img src="static/admin/images/face.jpg" class="userAvatar"/></div>'+
