layui.use(['form','layer','laydate','table','upload'],function(){
    ...
    var tableIns = table.render({
        ...
        id : "linkListTab",
        cols : [[
            {type: "checkbox", fixed:"left", width:50, style: "height:120px;"},
            {field: 'logo1', title: 'LOGO', width:190, style: "height:100px;", templet:function(d){
                return '<img src="'+d.logo+'" height="100"/><img src="'+d.logo+'" height="100" style="margin-left: 2px;"/>';
            }},
            {field: 'websiteName', title: '网站名称', align:'center', minWidth:240},
            {field: 'websiteUrl', title: '网站地址',width:300, align:'center', templet:function(d){
            ...
            {title: '操作', width:130,fixed:"right",align:"center",style: "height:120px;", templet:function(){
            ...
            $(".laytable-cell-1-logo1").removeClass("layui-table-cell");
        }
    });
    ...
    upload.render({
        elem: '.linkLogo',
        url: 'static/admin/json/linkLogo.json',
